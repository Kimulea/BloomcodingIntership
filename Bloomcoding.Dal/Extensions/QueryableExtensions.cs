...
namespace Bloomcoding.Dal.Extensions
{
    public static class QueryableExtensions
    {
        public async static Task<Common.Models.PagedRequest.PagedResult<TDto>> CreatePaginatedResultAsync<TEntity, TDto>(this IQueryable<TEntity> query, PagedRequest pagedRequest, IMapper mapper)
            ...
            where TDto : class
        {
            ...
            return new Common.Models.PagedRequest.PagedResult<TDto>()
            {
                Items = listResult,
